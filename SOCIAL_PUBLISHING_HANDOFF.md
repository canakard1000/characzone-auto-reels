...
- Live verification completed 2026-09-24: [renewal run 36008466944](https://github.com/canakard1000/characzone-auto-reels/actions/runs/36008466944) succeeded, including encrypted persistence and account verification. Ciphertext file was inspected structurally: only version/salt/nonce/ciphertext, no plaintext credential fields.
- [Publisher read-only run 36008598163](https://github.com/canakard1000/characzone-auto-reels/actions/runs/36008598163) succeeded with the encrypted current credential: 48 tests passed, account `gacha_m2026` verified, no container or content created.
- Latest API-estimated expiry is 2026-11-22T13:59:40Z. This same-day refresh returned approximately the previous expiry; do not claim a new full 60-day extension. The next weekly refresh becomes due 2026-10-01T13:50:46Z and will be attempted at the next daily schedule (normally October 2 at 03:17 UTC / 12:17 KST). Daily account checks begin with the next scheduled run. Use the renewal run summary for the latest actual expiry.
- Implementation commit: `b5da1c0a0491605bcaae328d56a45f33c2efa071`. This section supersedes the earlier one-time/manual-renewal instructions above. Normal renewal no longer requires browser login or manual GitHub Secret replacement; revoked access still requires user reauthorization.
